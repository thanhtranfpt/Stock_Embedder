...
def full_generation(args, model, ori_data):
    ...
    x_enc, masks, art_data = model.forward_mae(ori_data, masks)
...
def random_average_generation(args, model, ori_data):
    ...
    for i in range(num_gen):
        ...
        _, inter, generation = model.forward_mae(ori_data, masks)
...
def cross_concat_generation(args, model, ori_data):
    ...
    for i in range(num_gen):
        ...
        _, masks, generation = model.forward_mae(ori_data, masks)
